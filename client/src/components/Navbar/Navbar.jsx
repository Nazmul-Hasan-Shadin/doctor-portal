...
const Navbar = () => {
    return (
            ...
            <nav class="navbar navbar-expand-lg navbar-light " style={{ zIndex: "2" }}>
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link me-5 me-5" href="#">Dental Services</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-5 me-5 text-white " href="#">Reviews</a>
        </li>
        <li class="nav-item">
